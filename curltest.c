...
int main(int argc, char **argv) {
	...
	c = curl_easy_init();
	if(c) {
		curl_easy_setopt(c , CURLOPT_URL, "http://www.cc.puv.fi/~e1800931/curl.php");
		curl_easy_setopt(c , CURLOPT_POSTFIELDS,poststr); // "ID=e1800931&email=e1800931@edu.vamk.fi");
